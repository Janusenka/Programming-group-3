...
The data sets are compiled from administrative sources such as Eurostat and Destatis. Variables include:
...
```{r temporal-gpg, fig.width=12, fig.height=8, dpi=300}
...
ggsave("gpg_eu_2021_2023.png", width = 12, height = 9, dpi = 300)
```
